...
M.rules = {
  ...
  { pattern = "diff file with remote server", icon = "", color = "green" },
  { pattern = "init/edit deployment config", icon = "", color = "green" },
  { pattern = "download from remote", icon = "󰇚", color = "green" },
  { pattern = "upload to remote", icon = "󰕒", color = "green" },
  { pattern = "upload / download", icon = "", color = "green" },
  { pattern = "repeat transfer", icon = "󰑖", color = "green" },
